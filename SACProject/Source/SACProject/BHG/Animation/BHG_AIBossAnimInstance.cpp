...
void UBHG_AIBossAnimInstance::AnimNotify_DefaultAttackEnd()
{
	...
	GEngine->AddOnScreenDebugMessage(-1, 3.f, FColor::Red, FString::Printf(TEXT("Notify DefaultAttackEnd")));
...
void UBHG_AIBossAnimInstance::AnimNotify_DefaultAttack2End()
{
	...
	GEngine->AddOnScreenDebugMessage(-1, 3.f, FColor::Red, FString::Printf(TEXT("Notify DefaultAttack2End")));
